...
inactive_tab_foreground #{{base05-hex}}
...
@define-color text_color_disabled #{{base05-hex}};
...
/* ---------------------------------------------------------------------------
   Private-window override.
   Firefox/LibreWolf forces a fixed dark UI in private windows via internal
   chrome CSS that ignores most userChrome rules. Targeting the private-mode
   root selector with !important re-asserts our scheme; whether it lands
   depends on the browser version's internal cascade. Test by opening a
   private window after a theme apply — if the URL bar text is still
   illegible, the base16-accent extension at tools/firefox-extension/ is the
   fallback (it overrides via the theme.update API which DOES win).
--------------------------------------------------------------------------- */
:root[privatebrowsingmode="temporary"] {
  --lwt-accent-color: #{{base01-hex}} !important;
  --lwt-text-color: #{{accent-hex}} !important;
  --toolbar-bgcolor: #{{base01-hex}} !important;
  --toolbar-color: #{{accent-hex}} !important;
  --toolbar-field-background-color: #{{base00-hex}} !important;
  --toolbar-field-color: #{{accent-hex}} !important;
  --toolbar-field-border-color: #{{accent-hex}} !important;
  --toolbar-field-focus-background-color: #{{base00-hex}} !important;
  --toolbar-field-focus-border-color: #{{accent-hex}} !important;
  --tabs-navbar-color: #{{accent-hex}} !important;
  --tab-line-color: #{{accent-hex}} !important;
  --urlbar-popup-background: #{{base01-hex}} !important;
  --urlbar-popup-color: #{{accent-hex}} !important;
}

/* Direct selectors for elements that don't inherit from the variables. */
:root[privatebrowsingmode="temporary"] #urlbar,
:root[privatebrowsingmode="temporary"] #urlbar-background,
:root[privatebrowsingmode="temporary"] #searchbar {
  background-color: #{{base00-hex}} !important;
  color: #{{accent-hex}} !important;
  border-color: #{{accent-hex}} !important;
}
:root[privatebrowsingmode="temporary"] #urlbar input,
:root[privatebrowsingmode="temporary"] .urlbar-input {
  color: #{{accent-hex}} !important;
}
...
// firefoxThemeTemplate, firefoxManifestTemplate, firefoxBackgroundTemplate:
// retired in T5 (replaced by tools/firefox-extension/ + accent.json bridge).
// Kept around as unused string constants — Go permits this and removing them
// would churn line numbers in the file's tail. Safe to delete in a follow-up.
//
...
const firefoxThemeTemplate = `{
  ...
  "colors": {
    ...
    "toolbar_field_border": {"r": {{base05-dec-r}}, "g": {{base05-dec-g}}, "b": {{base05-dec-b}}, "a": 1},
    ...
    "popup_border": {"r": {{base05-dec-r}}, "g": {{base05-dec-g}}, "b": {{base05-dec-b}}, "a": 1},
    ...
    "sidebar_border": {"r": {{base05-dec-r}}, "g": {{base05-dec-g}}, "b": {{base05-dec-b}}, "a": 1},
...
// Structure mirrors ~/Downloads/themerc.template (Simply-Circles-Light by
// Jorge Cabrera). @vars@ are mapped to base16 slots:
//
...
//	@menu.bg.color@                   → base00
//	@menu.text.color@                 → base05
//	@window.active.title.bg.color@    → base01
//	@window.active.title.text.color@  → contrast-safe foreground on base01
//	@window.inactive.title.bg.color@  → base00
//	@window.inactive.title.text.color@→ contrast-safe foreground on base00
//	@theme_selection@                 → accent/select
//	@theme_black@                     → base00  (variant-base — light or dark
//	                                             bg, depending on scheme)
//	@theme_light_gray@                → base02
const openboxTemplate = `# Base16 {{scheme-name}} — generated by base16changer
# Scheme author: {{scheme-author}}
# Template: ~/Downloads/themerc.template (Simply-Circles-Light by Jorge Cabrera)
...
window.active.client.color: #{{accent-hex}}
window.inactive.client.color: #{{base02-hex}}
...
menu.title.text.color: #{{openbox-title-fg-hex}}

menu.items.bg: Solid Flat
menu.items.bg.color: #{{base00-hex}}
menu.items.text.color: #{{openbox-bg-fg-hex}}
menu.items.disabled.text.color: #{{openbox-bg-fg-hex}}

menu.items.active.bg: Solid Flat
menu.items.active.bg.color: #{{base02-hex}}
menu.items.active.text.color: #{{openbox-hover-fg-hex}}

menu.separator.color: #{{base00-hex}}
...
window.active.title.bg.border.color: #{{accent-hex}}
window.active.label.bg: Parentrelative
window.active.label.text.color: #{{openbox-title-fg-hex}}

window.active.handle.bg: Flat solid
window.active.handle.bg.color: #{{base01-hex}}
window.active.grip.bg: Flat solid
window.active.grip.bg.color: #{{base01-hex}}

window.active.button.unpressed.bg: Flat solid
window.active.button.unpressed.bg.color: #{{base00-hex}}
window.active.button.unpressed.bg.border.color: #{{base00-hex}}
window.active.button.unpressed.image.color: #{{openbox-bg-fg-hex}}

window.active.button.pressed.bg: Flat solid
window.active.button.pressed.bg.color: #{{openbox-selected-bg-hex}}
window.active.button.pressed.bg.border.color: #{{openbox-selected-bg-hex}}
window.active.button.pressed.image.color: #{{openbox-selected-fg-hex}}

window.active.button.disabled.bg: Flat solid
window.active.button.disabled.bg.color: #{{base02-hex}}
window.active.button.disabled.image.color: #{{openbox-hover-fg-hex}}

window.active.button.toggled.unpressed.bg: Flat solid
window.active.button.toggled.unpressed.bg.color: #{{base02-hex}}
window.active.button.toggled.unpressed.bg.border.color: #{{base02-hex}}
window.active.button.toggled.unpressed.image.color: #{{openbox-hover-fg-hex}}

window.active.button.toggled.pressed.bg: Flat solid
window.active.button.toggled.pressed.bg.color: #{{openbox-selected-bg-hex}}
window.active.button.toggled.pressed.bg.border.color: #{{openbox-selected-bg-hex}}
window.active.button.toggled.pressed.image.color: #{{openbox-selected-fg-hex}}

window.active.button.toggled.hover.bg: Flat solid
window.active.button.toggled.hover.bg.color: #{{base02-hex}}
window.active.button.toggled.hover.bg.border.color: #{{base02-hex}}
window.active.button.toggled.hover.image.color: #{{openbox-hover-accent-hex}}

window.active.button.hover.bg: Flat solid
window.active.button.hover.bg.color: #{{base02-hex}}
window.active.button.hover.bg.border.color: #{{base02-hex}}
window.active.button.hover.image.color: #{{openbox-hover-accent-hex}}

window.active.button.close.hover.bg: Flat solid
window.active.button.close.hover.bg.color: #{{openbox-destructive-bg-hex}}
window.active.button.close.hover.bg.border.color: #{{openbox-destructive-bg-hex}}
window.active.button.close.hover.image.color: #{{openbox-destructive-fg-hex}}
window.active.button.close.pressed.bg: Flat solid
window.active.button.close.pressed.bg.color: #{{openbox-destructive-bg-hex}}
window.active.button.close.pressed.bg.border.color: #{{openbox-destructive-bg-hex}}
window.active.button.close.pressed.image.color: #{{openbox-destructive-fg-hex}}

### Inactive windows ###
window.inactive.title.bg: Flat solid
window.inactive.title.bg.color: #{{base00-hex}}
window.inactive.title.bg.border.color: #{{base00-hex}}
window.inactive.label.bg: Parentrelative
window.inactive.label.text.color: #{{openbox-bg-fg-hex}}

window.inactive.handle.bg: Flat solid
window.inactive.handle.bg.color: #{{base00-hex}}
window.inactive.grip.bg: Flat solid
window.inactive.grip.bg.color: #{{base00-hex}}

window.inactive.button.unpressed.bg: Flat solid
window.inactive.button.unpressed.bg.color: #{{base00-hex}}
window.inactive.button.unpressed.bg.border.color: #{{base00-hex}}
window.inactive.button.unpressed.image.color: #{{openbox-bg-fg-hex}}

window.inactive.button.pressed.bg: Flat solid
window.inactive.button.pressed.bg.color: #{{openbox-selected-bg-hex}}
window.inactive.button.pressed.bg.border.color: #{{openbox-selected-bg-hex}}
window.inactive.button.pressed.image.color: #{{openbox-selected-fg-hex}}

window.inactive.button.disabled.bg: Flat solid
window.inactive.button.disabled.bg.color: #{{base02-hex}}
window.inactive.button.disabled.image.color: #{{openbox-hover-fg-hex}}

window.inactive.button.toggled.unpressed.bg: Flat solid
window.inactive.button.toggled.unpressed.bg.color: #{{base02-hex}}
window.inactive.button.toggled.unpressed.bg.border.color: #{{base02-hex}}
window.inactive.button.toggled.unpressed.image.color: #{{openbox-hover-fg-hex}}

window.inactive.button.toggled.pressed.bg: Flat solid
window.inactive.button.toggled.pressed.bg.color: #{{openbox-selected-bg-hex}}
window.inactive.button.toggled.pressed.bg.border.color: #{{openbox-selected-bg-hex}}
window.inactive.button.toggled.pressed.image.color: #{{openbox-selected-fg-hex}}

window.inactive.button.toggled.hover.bg: Flat solid
window.inactive.button.toggled.hover.bg.color: #{{base02-hex}}
window.inactive.button.toggled.hover.bg.border.color: #{{base02-hex}}
window.inactive.button.toggled.hover.image.color: #{{openbox-hover-accent-hex}}

window.inactive.button.hover.bg: Flat solid
window.inactive.button.hover.bg.color: #{{base02-hex}}
window.inactive.button.hover.bg.border.color: #{{base02-hex}}
window.inactive.button.hover.image.color: #{{openbox-hover-accent-hex}}

window.inactive.button.close.hover.bg: Flat solid
window.inactive.button.close.hover.bg.color: #{{openbox-destructive-bg-hex}}
window.inactive.button.close.hover.bg.border.color: #{{openbox-destructive-bg-hex}}
window.inactive.button.close.hover.image.color: #{{openbox-destructive-fg-hex}}
window.inactive.button.close.pressed.bg: Flat solid
window.inactive.button.close.pressed.bg.color: #{{openbox-destructive-bg-hex}}
window.inactive.button.close.pressed.bg.border.color: #{{openbox-destructive-bg-hex}}
window.inactive.button.close.pressed.image.color: #{{openbox-destructive-fg-hex}}

### On-Screen-Display ###
osd.border.width: 0
osd.border.color: #{{base02-hex}}
osd.bg: flat border solid
osd.bg.color: #{{base01-hex}}
osd.bg.border.color: #{{base02-hex}}
osd.label.bg: parentrelative
osd.label.text.color: #{{openbox-title-fg-hex}}
osd.hilight.bg: raised gradient vertical
osd.hilight.bg.color: #{{base02-hex}}
osd.hilight.bg.border.color: #{{base02-hex}}
`
