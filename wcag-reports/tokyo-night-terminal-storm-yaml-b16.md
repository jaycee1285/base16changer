# WCAG AA report — tokyo-night-terminal-storm.yaml
...
- **summary**: 64 pass / 87 fail / 151 total
...
| intra | fuzzel | selection-text on selection | `base05` #787c99 | `base03` #444b6a | **2.09:1** | `base07` (#d5d6db, 5.88:1) | user-flagged: selection often dark-on-dark in light themes |
| intra | fuzzel | selection-match on selection | `accent` #ff9e64 | `base03` #444b6a | **4.20:1** | `base0C` (#7dcfff, 4.98:1) |  |
...
| intra | openbox | inactive title text on inactive title bg | `base03` #444b6a | `base00` #24283b | **1.71:1** | `base06` (#cbccd1, 9.08:1) | user-flagged proxy: inactive titlebar text often dark-on-dark |
...
| intra | openbox | menu disabled on menu bg | `base03` #444b6a | `base00` #24283b | **1.71:1** | `base06` (#cbccd1, 9.08:1) |  |
...
| intra | gtk3 | disabled text on bg | `base03` #444b6a | `base00` #24283b | **1.71:1** | `base06` (#cbccd1, 9.08:1) |  |
...
| intra | firefox | popup border on popup bg | `base03` #444b6a | `base01` #1a1b26 | **2.00:1** | `base06` (#cbccd1, 10.66:1) |  |
| intra | firefox | sidebar text on sidebar bg | `base05` #787c99 | `base00` #24283b | **3.57:1** | `base07` (#d5d6db, 10.04:1) |  |
| intra | firefox | sidebar border on sidebar bg | `base03` #444b6a | `base00` #24283b | **1.71:1** | `base06` (#cbccd1, 9.08:1) |  |
...
| stack | fuzzel-on-gtk4 | selected_fg (base05) on selected_bg (base03) | `base05` #787c99 | `base03` #444b6a | **2.09:1** | `base07` (#d5d6db, 5.88:1) | USER-FLAGGED #3a: selection text reads as dark-on-dark in light themes |
| stack | fuzzel-on-gtk4 | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #444b6a | `base01` #1a1b26 | **2.00:1** | `base06` (#cbccd1, 10.66:1) | USER-FLAGGED #3b: selection highlight has to stand out against the menu |
| stack | fuzzel-on-gtk4 | selection_match (accent) on selected_bg (base03) | `accent` #ff9e64 | `base03` #444b6a | **4.20:1** | `base0C` (#7dcfff, 4.98:1) | USER-FLAGGED #3c: typed-letter highlight inside the selected row |
...
| ❌ | popup border on popup bg | `base03` #444b6a | `base01` #1a1b26 | 2.00:1 |
...
| ❌ | sidebar border on sidebar bg | `base03` #444b6a | `base00` #24283b | 1.71:1 |
...
| ❌ | selection-text on selection | `base05` #787c99 | `base03` #444b6a | 2.09:1 |
| ❌ | selection-match on selection | `accent` #ff9e64 | `base03` #444b6a | 4.20:1 |
...
| ❌ | disabled text on bg | `base03` #444b6a | `base00` #24283b | 1.71:1 |
...
| ❌ | inactive title text on inactive title bg | `base03` #444b6a | `base00` #24283b | 1.71:1 |
...
| ❌ | menu disabled on menu bg | `base03` #444b6a | `base00` #24283b | 1.71:1 |
...
| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ❌ | selected_fg (base05) on selected_bg (base03) | `base05` #787c99 | `base03` #444b6a | 2.09:1 |
| ❌ | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #444b6a | `base01` #1a1b26 | 2.00:1 |
| ❌ | selection_match (accent) on selected_bg (base03) | `accent` #ff9e64 | `base03` #444b6a | 4.20:1 |
