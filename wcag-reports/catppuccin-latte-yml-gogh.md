# WCAG AA report — Catppuccin Latte.yml
...
- **summary**: 67 pass / 89 fail / 156 total
...
| intra | fuzzel | selection-text on selection | `base05` #4c4f69 | `base03` #6c6f85 | **1.62:1** | — | user-flagged: selection often dark-on-dark in light themes |
| intra | fuzzel | selection-match on selection | `accent` #d20f39 | `base03` #6c6f85 | **1.10:1** | — |  |
...
| intra | openbox | inactive title text on inactive title bg | `base03` #6c6f85 | `base00` #eff1f5 | **4.37:1** | `base05` (#4c4f69, 7.06:1) | user-flagged proxy: inactive titlebar text often dark-on-dark |
...
| intra | openbox | menu disabled on menu bg | `base03` #6c6f85 | `base00` #eff1f5 | **4.37:1** | `base05` (#4c4f69, 7.06:1) |  |
| intra | openbox | close button (red) on active title | `base08` #d20f39 | `base01` #dfe1e7 | **4.15:1** | — |  |
| intra | gtk3 | disabled text on bg | `base03` #6c6f85 | `base00` #eff1f5 | **4.37:1** | `base05` (#4c4f69, 7.06:1) |  |
...
| intra | firefox | popup border on popup bg | `base03` #6c6f85 | `base01` #dfe1e7 | **3.78:1** | `base05` (#4c4f69, 6.11:1) |  |
| intra | firefox | selected suggestion url on hover bg | `accent` #d20f39 | `base02` #ced1d9 | **3.55:1** | — |  |
| intra | firefox | sidebar border on sidebar bg | `base03` #6c6f85 | `base00` #eff1f5 | **4.37:1** | `base05` (#4c4f69, 7.06:1) |  |
...
| stack | code-in-gtk4 | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | user-flagged: same color but rendered inside a tooltip/popover — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #ced1d9 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #dfe1e7 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | fuzzel-on-gtk4 | selected_fg (base05) on selected_bg (base03) | `base05` #4c4f69 | `base03` #6c6f85 | **1.62:1** | — | USER-FLAGGED #3a: selection text reads as dark-on-dark in light themes |
| stack | fuzzel-on-gtk4 | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #6c6f85 | `base01` #dfe1e7 | **3.78:1** | `base05` (#4c4f69, 6.11:1) | USER-FLAGGED #3b: selection highlight has to stand out against the menu |
| stack | fuzzel-on-gtk4 | selection_match (accent) on selected_bg (base03) | `accent` #d20f39 | `base03` #6c6f85 | **1.10:1** | — | USER-FLAGGED #3c: typed-letter highlight inside the selected row |
...
| ❌ | popup border on popup bg | `base03` #6c6f85 | `base01` #dfe1e7 | 3.78:1 |
...
| ❌ | sidebar border on sidebar bg | `base03` #6c6f85 | `base00` #eff1f5 | 4.37:1 |
...
| ❌ | selection-text on selection | `base05` #4c4f69 | `base03` #6c6f85 | 1.62:1 |
| ❌ | selection-match on selection | `accent` #d20f39 | `base03` #6c6f85 | 1.10:1 |
...
| ❌ | disabled text on bg | `base03` #6c6f85 | `base00` #eff1f5 | 4.37:1 |
...
| ❌ | inactive title text on inactive title bg | `base03` #6c6f85 | `base00` #eff1f5 | 4.37:1 |
...
| ❌ | menu disabled on menu bg | `base03` #6c6f85 | `base00` #eff1f5 | 4.37:1 |
...
| ❌ | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
| ❌ | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
| ❌ | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #ced1d9 | NaN:1 |
| ❌ | syntect comment on GTK-4 view_bg | `tm:comment (unresolved)` — | `base00` #eff1f5 | NaN:1 |
| ❌ | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
| ❌ | syntect string on GTK-4 view_bg | `tm:string (unresolved)` — | `base00` #eff1f5 | NaN:1 |
| ❌ | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
| ❌ | syntect keyword on GTK-4 view_bg | `tm:keyword (unresolved)` — | `base00` #eff1f5 | NaN:1 |
| ❌ | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
| ❌ | syntect function on GTK-4 view_bg | `tm:function (unresolved)` — | `base00` #eff1f5 | NaN:1 |
| ❌ | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
...
| ❌ | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #dfe1e7 | NaN:1 |
...
| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ❌ | selected_fg (base05) on selected_bg (base03) | `base05` #4c4f69 | `base03` #6c6f85 | 1.62:1 |
| ❌ | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #6c6f85 | `base01` #dfe1e7 | 3.78:1 |
| ❌ | selection_match (accent) on selected_bg (base03) | `accent` #d20f39 | `base03` #6c6f85 | 1.10:1 |
