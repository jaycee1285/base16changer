# WCAG AA report — Tokyo Night Storm.yml
...
- **summary**: 102 pass / 49 fail / 151 total
...
| intra | fuzzel | selection-match on selection | `accent` #f7768e | `base03` #414868 | **3.38:1** | `base0C` (#7dcfff, 5.21:1) |  |
...
| intra | openbox | inactive title text on inactive title bg | `base03` #414868 | `base00` #24283b | **1.63:1** | `base05` (#c0caf5, 9.02:1) | user-flagged proxy: inactive titlebar text often dark-on-dark |
...
| intra | openbox | menu disabled on menu bg | `base03` #414868 | `base00` #24283b | **1.63:1** | `base05` (#c0caf5, 9.02:1) |  |
| intra | openbox | close button (red) on active title | `base08` #f7768e | `base01` #34384e | **4.36:1** | `base0C` (#7dcfff, 6.72:1) |  |
| intra | gtk3 | disabled text on bg | `base03` #414868 | `base00` #24283b | **1.63:1** | `base05` (#c0caf5, 9.02:1) |  |
...
| intra | firefox | popup border on popup bg | `base03` #414868 | `base01` #34384e | **1.29:1** | `base05` (#c0caf5, 7.14:1) |  |
| intra | firefox | selected suggestion url on hover bg | `accent` #f7768e | `base02` #434860 | **3.40:1** | `base0C` (#7dcfff, 5.24:1) |  |
| intra | firefox | sidebar border on sidebar bg | `base03` #414868 | `base00` #24283b | **1.63:1** | `base05` (#c0caf5, 9.02:1) |  |
...
| stack | code-in-gtk4 | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #34384e | **NaN:1** | — | user-flagged: same color but rendered inside a tooltip/popover — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #434860 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #34384e | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | fuzzel-on-gtk4 | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #414868 | `base01` #34384e | **1.29:1** | `base05` (#c0caf5, 7.14:1) | USER-FLAGGED #3b: selection highlight has to stand out against the menu |
| stack | fuzzel-on-gtk4 | selection_match (accent) on selected_bg (base03) | `accent` #f7768e | `base03` #414868 | **3.38:1** | `base0C` (#7dcfff, 5.21:1) | USER-FLAGGED #3c: typed-letter highlight inside the selected row |
...
| ❌ | popup border on popup bg | `base03` #414868 | `base01` #34384e | 1.29:1 |
...
| ❌ | sidebar border on sidebar bg | `base03` #414868 | `base00` #24283b | 1.63:1 |
...
| ✅ | selection-text on selection | `base05` #c0caf5 | `base03` #414868 | 5.53:1 |
| ❌ | selection-match on selection | `accent` #f7768e | `base03` #414868 | 3.38:1 |
...
| ❌ | disabled text on bg | `base03` #414868 | `base00` #24283b | 1.63:1 |
...
| ❌ | inactive title text on inactive title bg | `base03` #414868 | `base00` #24283b | 1.63:1 |
...
| ❌ | menu disabled on menu bg | `base03` #414868 | `base00` #24283b | 1.63:1 |
...
| ❌ | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #34384e | NaN:1 |
| ❌ | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #34384e | NaN:1 |
| ❌ | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #434860 | NaN:1 |
| ❌ | syntect comment on GTK-4 view_bg | `tm:comment (unresolved)` — | `base00` #24283b | NaN:1 |
| ❌ | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #34384e | NaN:1 |
| ❌ | syntect string on GTK-4 view_bg | `tm:string (unresolved)` — | `base00` #24283b | NaN:1 |
| ❌ | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #34384e | NaN:1 |
| ❌ | syntect keyword on GTK-4 view_bg | `tm:keyword (unresolved)` — | `base00` #24283b | NaN:1 |
| ❌ | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #34384e | NaN:1 |
| ❌ | syntect function on GTK-4 view_bg | `tm:function (unresolved)` — | `base00` #24283b | NaN:1 |
| ❌ | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #34384e | NaN:1 |
...
| ❌ | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #34384e | NaN:1 |
...
| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ✅ | selected_fg (base05) on selected_bg (base03) | `base05` #c0caf5 | `base03` #414868 | 5.53:1 |
| ❌ | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #414868 | `base01` #34384e | 1.29:1 |
| ❌ | selection_match (accent) on selected_bg (base03) | `accent` #f7768e | `base03` #414868 | 3.38:1 |
