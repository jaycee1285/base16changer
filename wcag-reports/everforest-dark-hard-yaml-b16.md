...
| intra | fuzzel | selection-text on selection | `base05` #d3c6aa | `base03` #859289 | **1.92:1** | — | user-flagged: selection often dark-on-dark in light themes |
| intra | fuzzel | selection-match on selection | `accent` #7fbbb3 | `base03` #859289 | **1.49:1** | — |  |
| intra | openbox | inactive title text on inactive title bg | `base03` #859289 | `base00` #272e33 | **4.24:1** | `base06` (#edeada, 11.40:1) | user-flagged proxy: inactive titlebar text often dark-on-dark |
| intra | openbox | inactive button icon on inactive btn bg | `base03` #859289 | `base00` #272e33 | **4.24:1** | `base06` (#edeada, 11.40:1) |  |
| intra | openbox | menu disabled on menu bg | `base03` #859289 | `base00` #272e33 | **4.24:1** | `base06` (#edeada, 11.40:1) |  |
| intra | openbox | close button (red) on active title | `base08` #e67e80 | `base01` #2e383c | **4.38:1** | `base0A` (#dbbc7f, 6.59:1) |  |
| intra | gtk3 | disabled text on bg | `base03` #859289 | `base00` #272e33 | **4.24:1** | `base06` (#edeada, 11.40:1) |  |
...
| intra | firefox | popup border on popup bg | `base03` #859289 | `base01` #2e383c | **3.70:1** | `base06` (#edeada, 9.95:1) |  |
| intra | firefox | selected suggestion url on hover bg | `accent` #7fbbb3 | `base02` #414b50 | **4.12:1** | `base0A` (#dbbc7f, 4.90:1) |  |
| intra | firefox | sidebar border on sidebar bg | `base03` #859289 | `base00` #272e33 | **4.24:1** | `base06` (#edeada, 11.40:1) |  |
| intra | firefox | danger (.close-icon hover) on toolbar | `base08` #e67e80 | `base01` #2e383c | **4.38:1** | `base0A` (#dbbc7f, 6.59:1) |  |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 view_bg | `tm:heading (unresolved)` — | `base00` #272e33 | **NaN:1** | — | user-flagged: heading scope foreground from .tmTheme, against GTK-4 view bg — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #2e383c | **NaN:1** | — | user-flagged: same color but rendered inside a tooltip/popover — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #414b50 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect comment on GTK-4 view_bg | `tm:comment (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect string on GTK-4 view_bg | `tm:string (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect keyword on GTK-4 view_bg | `tm:keyword (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect function on GTK-4 view_bg | `tm:function (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect type on GTK-4 view_bg | `tm:type (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect number on GTK-4 view_bg | `tm:number (unresolved)` — | `base00` #272e33 | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
...
| stack | code-in-gtk4 | syntect default fg on GTK-4 view_bg | `tm:__fg (unresolved)` — | `base00` #272e33 | **NaN:1** | — | tmTheme global default fg — what bracket/punctuation/everything-else falls back to — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #2e383c | **NaN:1** | — | skipped: fg unresolved (no tmTheme or missing scope) |
| stack | code-in-gtk4 | tmTheme default bg leaks past GTK-4 view_bg | `tm:__bg (unresolved)` — | `base00` #272e33 | **NaN:1** | — | if tmTheme bg differs from GTK-4 view bg, the gutter strip seam fails — skipped: fg unresolved (no tmTheme or missing scope) |
| stack | fuzzel-on-gtk4 | selected_fg (base05) on selected_bg (base03) | `base05` #d3c6aa | `base03` #859289 | **1.92:1** | — | USER-FLAGGED #3a: selection text reads as dark-on-dark in light themes |
| stack | fuzzel-on-gtk4 | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #859289 | `base01` #2e383c | **3.70:1** | `base06` (#edeada, 9.95:1) | USER-FLAGGED #3b: selection highlight has to stand out against the menu |
| stack | fuzzel-on-gtk4 | selection_match (accent) on selected_bg (base03) | `accent` #7fbbb3 | `base03` #859289 | **1.49:1** | — | USER-FLAGGED #3c: typed-letter highlight inside the selected row |
...
| ❌ | popup border on popup bg | `base03` #859289 | `base01` #2e383c | 3.70:1 |
...
| ❌ | sidebar border on sidebar bg | `base03` #859289 | `base00` #272e33 | 4.24:1 |
...
### intra — fuzzel (4/6 pass)

| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ✅ | text on background | `base05` #d3c6aa | `base01` #2e383c | 7.11:1 |
| ✅ | match on background | `accent` #7fbbb3 | `base01` #2e383c | 5.53:1 |
| ❌ | selection-text on selection | `base05` #d3c6aa | `base03` #859289 | 1.92:1 |
| ❌ | selection-match on selection | `accent` #7fbbb3 | `base03` #859289 | 1.49:1 |
...
| ❌ | disabled text on bg | `base03` #859289 | `base00` #272e33 | 4.24:1 |
...
| ❌ | inactive title text on inactive title bg | `base03` #859289 | `base00` #272e33 | 4.24:1 |
...
| ❌ | menu disabled on menu bg | `base03` #859289 | `base00` #272e33 | 4.24:1 |
...
| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ❌ | syntect HEADING on GTK-4 view_bg | `tm:heading (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect HEADING on GTK-4 popover_bg | `tm:heading (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect HEADING on GTK-4 sidebar_bg | `tm:heading (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect HEADING on GTK-4 selection_bg | `tm:heading (unresolved)` — | `base02` #414b50 | NaN:1 |
| ❌ | syntect comment on GTK-4 view_bg | `tm:comment (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect comment on GTK-4 popover_bg | `tm:comment (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect string on GTK-4 view_bg | `tm:string (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect string on GTK-4 popover_bg | `tm:string (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect keyword on GTK-4 view_bg | `tm:keyword (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect keyword on GTK-4 popover_bg | `tm:keyword (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect function on GTK-4 view_bg | `tm:function (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect function on GTK-4 popover_bg | `tm:function (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | syntect type on GTK-4 view_bg | `tm:type (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect number on GTK-4 view_bg | `tm:number (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect link on GTK-4 view_bg | `tm:link (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect default fg on GTK-4 view_bg | `tm:__fg (unresolved)` — | `base00` #272e33 | NaN:1 |
| ❌ | syntect default fg on GTK-4 popover_bg | `tm:__fg (unresolved)` — | `base01` #2e383c | NaN:1 |
| ❌ | tmTheme default bg leaks past GTK-4 view_bg | `tm:__bg (unresolved)` — | `base00` #272e33 | NaN:1 |
...
| ✓ | Role | fg | bg | Ratio |
|---|------|----|----|-------|
| ❌ | selected_fg (base05) on selected_bg (base03) | `base05` #d3c6aa | `base03` #859289 | 1.92:1 |
| ❌ | selected_bg (base03) vs fuzzel bg (base01) — stripe visibility | `base03` #859289 | `base01` #2e383c | 3.70:1 |
| ❌ | selection_match (accent) on selected_bg (base03) | `accent` #7fbbb3 | `base03` #859289 | 1.49:1 |
